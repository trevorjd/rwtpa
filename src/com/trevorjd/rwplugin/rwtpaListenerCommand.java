...
public class rwtpaListenerCommand implements Listener
{
    ...
    public void onPlayerCommand(PlayerCommandEvent event)
    {
        ...
        if (cmd[0].equals(COMMAND_PREFIX))
        {
            ...
            {
                // process /tpa clear
                if (cmd[1].equals(COMMAND_CLEAR_PREFIX))
                {
                ...
                else
                {
                    ...
                    player.sendTextMessage(MSG_PLAYER_USAGE_1 + ": " + COMMAND_PREFIX + " " + COMMAND_SEND_PREFIX + " <" + MSG_PLAYER_USAGE_2 + ">");
                }
                ...
                if (null != myrwtpa.getPlayerbyName(cmd[2]))
                    {
                        ...
                        switch (cmd[1]) {
                            case COMMAND_SEND_PREFIX :
                                ...
                                } else
                                {
                                    ...
                                    if (target.hasAttribute("BlockList"))
                                    {
                                        ...
                                        System.out.println("playerBlocked: " + playerBlocked);
                                    }
                            ...
                            case COMMAND_BLOCK_PREFIX :
                                // player, block, target
                                target = myrwtpa.getPlayerbyName(cmd[2]);
                                System.out.println("Player" + player + " is blocking" + target.getName());
